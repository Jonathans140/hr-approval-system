      ...
      <div className="container flex h-14 items-center">
        <div className="mr-4 hidden md:flex">
          ...
          <nav className="flex items-center space-x-6 text-sm font-medium">
            <Link href="/requester" className="transition-colors hover:text-foreground/80 text-foreground">
              Dashboard
            </Link>
            <Link href="/requester/new" className="transition-colors hover:text-foreground/80 text-muted-foreground">
              New Request
            </Link>
          </nav>
        </div>
